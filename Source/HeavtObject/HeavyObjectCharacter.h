...
UCLASS(config=Game)
class AHeavyObjectCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class AHeavtObjectProjectile> ProjectileClass;
...
protected:
	...
	/*Called via input to interact with object player is looking at*/
	void Interact();
